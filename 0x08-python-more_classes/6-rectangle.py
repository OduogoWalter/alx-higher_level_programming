...
class Rectangle:
    """Rectangle class with private width and height attrributes"""
    ...
    def perimeter(self):
        ...
        return (0 if self.__width == 0 or
                self.height == 0 else 2 * (self.__width + self.__height))
    ...
    def __repr__(self):
        """Method tob create a representation of the rectangle"""
